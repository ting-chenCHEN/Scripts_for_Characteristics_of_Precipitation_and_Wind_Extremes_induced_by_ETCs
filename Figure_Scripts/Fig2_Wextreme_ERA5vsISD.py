...
filet='ERA5_regridded_ISDstation_WS_p99p0.nc4'
...
#--------------------------------------------------------
    zz=100.*exces.sel(season=sea).variables['sfcWind'].values/tot.variables['sfcWind'].values
...
plt.savefig('Fig2_Wind_ex990values_freq_ISD_vs_ERA5', bbox_inches='tight', dpi=200)
plt.show()
plt.close()
da.close()
ds.close()
