...
ETCcont1= ETCprob1*EXcase1/EXcaseall
ratio1=ETCprob1
EXfreq1= EXcase1/EXcaseall
sea1='JJA'
IETCcont1= IETCprob1*IEXcase1/IEXcaseall
Iratio1=IETCprob1
IEXfreq1= IEXcase1/IEXcaseall

ETCcont2= ETCprob2*EXcase2/EXcaseall
ratio2=ETCprob2
EXfreq2= EXcase2/EXcaseall
sea2='SON'
IETCcont2= IETCprob2*IEXcase2/IEXcaseall
Iratio2=IETCprob2
IEXfreq2= IEXcase2/IEXcaseall

ETCcont3= ETCprob3*EXcase3/EXcaseall
ratio3=ETCprob3
EXfreq3= EXcase3/EXcaseall
sea3='DJF'
IETCcont3= IETCprob3*IEXcase3/IEXcaseall
Iratio3=IETCprob3
IEXfreq3= IEXcase3/IEXcaseall

ETCcont4= ETCprob4*EXcase4/EXcaseall
ratio4=ETCprob4
EXfreq4= EXcase4/EXcaseall
sea4='MAM'
IETCcont4= IETCprob4*IEXcase4/IEXcaseall
Iratio4=IETCprob4
...
ETCcont1=np.ma.masked_where(EXfreq1*100<0.5,ETCcont1)
ETCcont2=np.ma.masked_where(EXfreq2*100<0.5,ETCcont2)
ETCcont3=np.ma.masked_where(EXfreq3*100<0.5,ETCcont3)
ETCcont4=np.ma.masked_where(EXfreq4*100<0.5,ETCcont4)
...
IETCcont1=np.ma.masked_where(IEXfreq1*100<0.5,IETCcont1)
IETCcont2=np.ma.masked_where(IEXfreq2*100<0.5,IETCcont2)
IETCcont3=np.ma.masked_where(IEXfreq3*100<0.5,IETCcont3)
IETCcont4=np.ma.masked_where(IEXfreq4*100<0.5,IETCcont4)
...
ax0.text(0.01,0.985,'(n)',bbox={'facecolor':'white','edgecolor':'None','alpha':0.9,'pad':2.0},
              horizontalalignment='left', verticalalignment='top',
              transform=ax0.transAxes,fontsize=18,zorder=28,**sans_font)

plt.savefig('Fig4_n', bbox_inches='tight', dpi=200)
plt.show()
plt.close()
